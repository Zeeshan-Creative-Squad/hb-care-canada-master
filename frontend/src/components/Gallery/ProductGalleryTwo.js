              ...
              <div className='d-flex flex-column flex-lg-row '>
                <div className="gallery-item ">
                  <img src="/images/gallery/EyebrowTweezers/1-min.png" alt="Img 2" className="gallery-image2" onClick={() => {
                    setShow(true); SetImg("/images/gallery/EyebrowTweezers/1-min.png")
                  }} />
                </div>
                <div className="gallery-item">
                  <img src="/images/gallery/EyebrowTweezers/2-min.png" alt="Img 1" className="gallery-image1" onClick={() => {
