...
const galleryImages = [
  "/images/gallery/ManicurePedicureNippers/4-min.jpg",
  "/images/gallery/ManicurePedicureNippers/5-min.jpg",
  "/images/gallery/ManicurePedicureNippers/6-min.jpg",
  "/images/gallery/ManicurePedicureNippers/7-min.jpg",
  "/images/gallery/ManicurePedicureNippers/8-min.jpg",
  "/images/gallery/ManicurePedicureNippers/9-min.jpg",
  "/images/gallery/ManicurePedicureNippers/10-min.jpg",
  "/images/gallery/ManicurePedicureNippers/11-min.jpg",
  "/images/gallery/ManicurePedicureNippers/12-min.jpg",
];
            ...
            <div className="gallery">
              <div className='d-flex flex-column flex-lg-row '>
                <div className="gallery-item ">
                  <img src="/images/gallery/ManicurePedicureNippers/1-min.png" alt="Img 2" className="gallery-image2" onClick={() => {
                    setShow(true); SetImg("/images/gallery/ManicurePedicureNippers/11-min.png")
                  }} />
                </div>
                <div className="gallery-item">
                  <img src="/images/gallery/ManicurePedicureNippers/2-min.png" alt="Img 1" className="gallery-image1" onClick={() => {
                    setShow(true); SetImg("/images/gallery/ManicurePedicureNippers/2-min.png")
                  }} />
                </div>
              </div>
