...
const galleryImages = [
  "/images/gallery/ManicurePedicureNailCutters/3-min.jpg",
  "/images/gallery/ManicurePedicureNailCutters/4-min.jpg",
  "/images/gallery/ManicurePedicureNailCutters/5-min.jpg",
  "/images/gallery/ManicurePedicureNailCutters/6-min.jpg",
];

const ProductGalleryFour = () => {
          ...
          <div className="gallery-section">
            <div className="gallery">
              <div className='d-flex flex-column flex-lg-row '>
                ...
                <div className="gallery-item">
                  <img src="/images/gallery/ManicurePedicureNailCutters/2-min.png" alt="Img 1" className="gallery-image1" onClick={() => {
                    setShow(true); SetImg("/images/gallery/ManicurePedicureNailCutters/2-min.png")
                  }} />
                </div>
              </div>
...
export default ProductGalleryFour;
