...
const galleryImages = [
  ...
  "/images/gallery/MedicalInstruments/7-min.jpg",
  "/images/gallery/MedicalInstruments/8-min.jpg",
  "/images/gallery/MedicalInstruments/9-min.jpg",
  "/images/gallery/MedicalInstruments/10-min.jpg",
  "/images/gallery/MedicalInstruments/11-min.jpg",
  "/images/gallery/MedicalInstruments/12-min.jpg",
  "/images/gallery/MedicalInstruments/13-min.jpg",
];

const ProductGalleryEight = () => {
          ...
          <div className="gallery-section">
            <div className="gallery">
              <div className='d-flex flex-column flex-lg-row '>
                ...
                <div className="gallery-item">
                  <img src="/images/gallery/MedicalInstruments/2-min.png" alt="Img 1" className="gallery-image1" onClick={() => {
                    setShow(true); SetImg("/images/gallery/MedicalInstruments/2-min.png")
                  }} />
                </div>
              </div>
...
export default ProductGalleryEight;
